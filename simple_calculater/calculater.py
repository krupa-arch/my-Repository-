...
btn_equale=tk.Button(root, text="=", command=evaluate_calculation, width=5, font=("arial, 14"))
btn_equale.grid(row=6, column=1)
btn_clear=tk.Button(root, text="AC", command=clear_field, width=5, font=("arial, 14"))
btn_clear.grid(row=6, column=2)
btn_pointing=tk.Button(root, text=".", command=lambda:clear_field, width=5, font=("arial, 14"))
btn_pointing.grid(row=6, column=3)
btn_back = tk.Button(root, text="←", command=backspace, width=5, font=("Arial", 14))
btn_back.grid(row=6, column=4)
